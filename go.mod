...
replace github.com/cosmos/cosmos-sdk => github.com/maticnetwork/cosmos-sdk v0.38.6

replace github.com/ethereum/go-ethereum => github.com/maticnetwork/bor v1.3.3
